<x-site-layout>
    ...
    <script>
        ...
        class MainMenuScene extends Phaser.Scene {
            ...
            preload() {
                this.load.image("background", "assets/alpine_woods.png");
            ...
            create() {
                ...
                const muteButton = this.add
                    .image(430, 50, isMuted ? "mute" : "unmute")
                    .setScale(0.5)
                    .setInteractive()
                    .on("pointerdown", () => {
                        isMuted = !isMuted;
                        muteButton.setTexture(isMuted ? "mute" : "unmute");
        ...
        class GamePlayScene extends Phaser.Scene {
            ...
            preload() {
                ...
                this.load.image("knife", "assets/knife.png"); // Load knife image for the slicing effect
            }

            create() {
                score = 0;
                countdown = 15; // Initialize countdown to 15 seconds
                this.add.image(240, 400, "background").setDisplaySize(480, 800);
            ...
            updateCountdown() {
                ...
                this.countdownText.setText(`Time: ${countdown}`); // Update the countdown text
